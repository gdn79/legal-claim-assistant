...
REQUISITE_PATTERNS: list[tuple[str, re.Pattern, str]] = [
    ...
    ("attachments", re.compile(r"приложени", re.IGNORECASE), "Отсутствует перечень приложений."),
    ("date_field", re.compile(r"20\d{2}\s*г(?:\.|од)", re.IGNORECASE), "В тексте не найдена дата."),
